        ...
        <>
            ...
            <form onSubmit={submission} className="rounded-lg shadow-lg max-w-md mx-auto space-y-6">
                ...
                <div className="flex justify-center">
                    ...
                    <AlertDialog >
                        <AlertDialogTrigger className="text-white py-2 px-6 rounded-md focus:outline-none focus:ring-2 focus:ring-white-500 cursor-pointer active:scale-95 transition-all duration-500  hover:bg-[rgb(34,34,34)] border border-[rgb(53,53,53)]" type="submit">Submit</AlertDialogTrigger>
                        <AlertDialogContent>
                            <AlertDialogHeader>
