...
export default function InfiniteScroll({
  ...
  // itemMinHeight = "100%", // Fixed height for each item
  // ----- Tilt Props -----
  ...
  useEffect(() => {
    ...
    let cumulativeY = 0;
    divItems.forEach((child, i) => {
      gsap.set(child, { y: cumulativeY });
      cumulativeY += itemHeights[i] + parseFloat(negativeMargin);
    });
  ...
  return (
    <div
      className="relative flex items-center justify-center w-full overflow-hidden overscroll-none  border-transparent"
      ref={wrapperRef}
      style={{ maxHeight }}
    >
      {/* Gradient Overlays */}
