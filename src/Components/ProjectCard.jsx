...
function ProjectCard({ 
    ...
    return (
        <div
            ref={cardRef}
            className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl overflow-hidden transition-all duration-300 hover:border-white/70 group cursor-pointer"
            style={{
